					...
					<div class="row">
						<div class="col-lg-3">
							<ul class="list-unstyled">
								<li><a href="index.php?ctrl=Product&action=product&id=<?php echo utf8_encode($result_productByCategory[$i]["id_product"]); ?>"><img width="170" height="150" alt="image" src="Model/images/<?php echo $result_productByCategory[$i]["image_product"]; ?>"></a></li>
							</ul>
						</div>
						<div class="col-lg-6">
							<br><br>
